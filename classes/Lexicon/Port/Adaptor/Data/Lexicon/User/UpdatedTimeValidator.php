<?php
	...
	/**
	 *
	 * Валидатор класса Lexicon\Port\Adaptor\Data\Lexicon\User\UpdatedTime
	 *
	 */
	class UpdatedTimeValidator extends \Happymeal\Port\Adaptor\Data\XML\Schema\StringValidator {
