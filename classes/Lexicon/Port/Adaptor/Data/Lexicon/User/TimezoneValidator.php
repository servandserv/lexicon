<?php
	...
	/**
	 *
	 * Валидатор класса Lexicon\Port\Adaptor\Data\Lexicon\User\Timezone
	 *
	 */
	class TimezoneValidator extends \Happymeal\Port\Adaptor\Data\XML\Schema\StringValidator {
