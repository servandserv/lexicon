<?php
	...
	/**
	 *
	 * Валидатор класса Lexicon\Port\Adaptor\Data\Lexicon\User\Verified
	 *
	 */
	class VerifiedValidator extends \Happymeal\Port\Adaptor\Data\XML\Schema\StringValidator {
