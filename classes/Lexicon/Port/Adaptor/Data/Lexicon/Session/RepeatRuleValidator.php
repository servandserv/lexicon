<?php
	...
	/**
	 *
	 * Валидатор класса Lexicon\Port\Adaptor\Data\Lexicon\Session\RepeatRule
	 *
	 */
	class RepeatRuleValidator extends \Happymeal\Port\Adaptor\Data\XML\Schema\IntegerValidator {
