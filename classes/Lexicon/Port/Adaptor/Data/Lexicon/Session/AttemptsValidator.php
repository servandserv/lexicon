<?php
	...
	/**
	 *
	 * Валидатор класса Lexicon\Port\Adaptor\Data\Lexicon\Session\Attempts
	 *
	 */
	class AttemptsValidator extends \Happymeal\Port\Adaptor\Data\XML\Schema\IntegerValidator {
